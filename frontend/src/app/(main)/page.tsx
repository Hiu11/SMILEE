...
export default function Home() {
  ...
  return (
    <div className="flex w-full flex-col overflow-hidden">
      ...
      {/* ── HERO ── */}
      <section className="relative flex min-h-screen items-center overflow-hidden bg-linear-to-br from-slate-50 via-blue-50/40 to-cyan-50/30 pt-24 dark:from-slate-950 dark:via-blue-950/20 dark:to-slate-950">
        ...
        <div className="container relative mx-auto grid gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
          <motion.div
            style={{ y: heroY }}
          ...
          >
            ...
            <motion.div
              ...
              className="mb-6 inline-flex w-fit items-center gap-2 rounded-full border border-blue-200/80 bg-white/80 px-4 py-2 text-sm font-bold text-blue-700 shadow-sm backdrop-blur dark:border-blue-800/50 dark:bg-slate-900/80 dark:text-cyan-300"
            >
            ...
            <h1 className="text-5xl font-black leading-[1.08] tracking-tight text-slate-900 dark:text-white md:text-6xl xl:text-7xl">
              Nụ cười{" "}
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <Button asChild className="group h-14 rounded-full bg-linear-to-r from-blue-600 to-blue-500 px-8 text-base font-bold text-white shadow-lg shadow-blue-500/35 transition-all hover:shadow-blue-500/50 hover:-translate-y-1 hover:scale-105">
                <Link href="/booking">
              ...
              <Button asChild variant="outline" className="h-14 rounded-full border-2 border-slate-200 bg-white/70 px-8 text-base font-bold backdrop-blur transition-all hover:-translate-y-1 hover:border-blue-300 hover:shadow-lg dark:border-slate-700 dark:bg-slate-900/70">
                <Link href="/contact">
          ...
          >
            <div className="relative h-[520px] w-full max-w-lg">
              ...
              <motion.div
                ...
                className="glass-card absolute left-0 top-[22%] z-20 hidden rounded-2xl p-4 shadow-xl sm:flex sm:items-center sm:gap-3"
              >
              ...
              <motion.div
                ...
                className="glass-card absolute bottom-[20%] right-0 z-20 hidden rounded-2xl p-4 shadow-xl sm:flex sm:items-center sm:gap-3"
              >
              ...
              <motion.div
                ...
                className="glass-card absolute right-[8%] top-[10%] z-20 hidden rounded-2xl px-4 py-3 shadow-xl sm:flex sm:items-center sm:gap-2"
              >
      ...
      {/* ── STATS ── */}
      <section className="relative bg-linear-to-r from-blue-600 via-blue-500 to-cyan-500 py-16 dark:from-blue-900 dark:via-blue-800 dark:to-cyan-900">
        <div className="pointer-events-none absolute inset-0 line-grid opacity-20" />
        <Stagger className="container mx-auto grid grid-cols-2 gap-6 px-4 sm:px-6 lg:grid-cols-4 lg:px-8">
          {stats.map((stat) => (
            <StaggerItem key={stat.label}>
              <div className="text-center">
                <p className="text-4xl font-black text-white">{stat.value}</p>
                <p className="mt-1 text-sm font-semibold text-blue-100">{stat.label}</p>
              </div>
            </StaggerItem>
          ))}
        </Stagger>
      ...
      <section className="bg-white py-24 dark:bg-slate-950">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal className="mx-auto mb-14 max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-4xl font-black tracking-tight text-slate-900 dark:text-white md:text-5xl">
              Giải pháp chăm sóc <span className="gradient-text">toàn diện</span>
            </h2>
            <p className="mt-4 text-lg text-slate-500 dark:text-slate-400">Đội ngũ chuyên gia với hơn 15 năm kinh nghiệm, ứng dụng công nghệ tiên tiến nhất.</p>
          </Reveal>

          <Stagger className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {services.map(({ icon: Icon, title, desc, color }) => (
              <StaggerItem key={title} whileHover={{ y: -8 }}>
                <article className="group relative h-full overflow-hidden rounded-2xl border border-slate-100 bg-slate-50 p-6 shadow-sm transition-shadow hover:shadow-2xl hover:shadow-blue-500/10 dark:border-slate-800 dark:bg-slate-900">
                  {/* Gradient hover bg */}
                  <div className={`absolute inset-0 bg-linear-to-br ${color} opacity-0 transition-opacity duration-500 group-hover:opacity-5`} />

                  <div className={`relative mb-5 flex h-13 w-13 items-center justify-center rounded-2xl bg-linear-to-br ${color} p-0.5 shadow-lg`}>
      ...
      <section className="relative overflow-hidden bg-slate-950 py-24">
        ...
        <div className="container relative mx-auto grid gap-14 px-4 sm:px-6 lg:grid-cols-2 lg:items-center lg:px-8">
            ...
            <div className="mt-10 space-y-6">
              {[
                ...
                <div key={String(title)} className="flex gap-5">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-blue-500/20 bg-blue-500/10 text-cyan-400">
                    <Icon className="h-6 w-6" />
                  </div>
                  <div>
                    <h3 className="font-extrabold text-white">{String(title)}</h3>
                    <p className="mt-1.5 text-sm leading-6 text-slate-400">{String(desc)}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      {/* ── TESTIMONIALS ── */}
      <section className="bg-linear-to-b from-slate-50 to-white py-24 dark:from-slate-900/50 dark:to-slate-950">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal className="mx-auto mb-14 max-w-3xl text-center">
      ...
      {/* ── CTA ── */}
      <section className="relative overflow-hidden bg-linear-to-br from-blue-600 via-blue-500 to-cyan-500 py-24 dark:from-blue-900 dark:via-blue-800 dark:to-cyan-900">
        <div className="pointer-events-none absolute inset-0 line-grid opacity-20" />
        ...
        <Reveal className="container relative mx-auto px-4 text-center sm:px-6 lg:px-8">
          ...
          <h2 className="mx-auto mt-6 max-w-3xl text-4xl font-black leading-tight text-white md:text-5xl lg:text-6xl">
          ...
          <div className="mt-10 flex flex-col justify-center gap-4 sm:flex-row">
            <Button asChild className="h-14 rounded-full bg-white px-10 text-base font-bold text-blue-600 shadow-xl shadow-blue-800/30 transition-all hover:-translate-y-1 hover:bg-slate-50 hover:scale-105">
              <Link href="/booking">
                <CalendarDays className="mr-2 h-5 w-5" />
                Đặt lịch trực tuyến
              </Link>
            </Button>
            <Button asChild variant="outline" className="h-14 rounded-full border-white/30 bg-white/10 px-10 text-base font-bold text-white backdrop-blur transition-all hover:-translate-y-1 hover:bg-white/20 hover:text-white">
              <Link href="/services">
